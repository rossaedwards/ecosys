...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dqk6fCpC.js
var router_Dqk6fCpC_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-DZILZPDS.css";
var APP_NAME = "Vibe Audio Player";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Vibe Audio Player — local music playback with a cinematic VASP 3.69 visualizer."
			},
			{
				name: "theme-color",
				content: "#07060c"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Lexend:wght@300;400;500;600;700&family=Syne:wght@600;700;800&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-CKkxQbI_.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-BFS4b1h8.mjs");
...
//#endregion
export { router_Dqk6fCpC_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
