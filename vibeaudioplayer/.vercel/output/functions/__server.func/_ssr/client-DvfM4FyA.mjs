...
import { i as getBaseURL, r as PACKAGE_VERSION, t as GENERIC_OAUTH_ERROR_CODES } from "./router-Dqk6fCpC.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/client-DvfM4FyA.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-[transform,background-color,box-shadow,opacity,color] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/70 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:not-disabled:scale-[0.96]", {
	variants: {
		variant: {
...
//#endregion
export { hashHue as a, signIn as c, formatTime as i, signOut as l, authClient as n, hexToRgb as o, cn as r, rgbToHex as s, Button as t, uid as u };
