...
axes[1].set_xlabel('λ_x_L')
axes[1].set_ylabel('Im(E) — Gain/Loss')
axes[1].set_title('Fig 6.7b — Imaginary Spectrum: Exceptional Point')
axes[1].legend()

plt.suptitle('Balance State Vector-Cell Non-Hermitian Chiral Edge States (Qiskit-compatible model)', fontsize=12)
plt.tight_layout()
