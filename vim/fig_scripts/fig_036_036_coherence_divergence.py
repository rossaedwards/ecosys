...
Section ID : section_XXXVI
Figure ID  : section_XXXVI_fig36
Label      : Figure 36
...
def run_simulation(output_dir: Path | None = None) -> Path:
    """Generate coherence-weighted divergence ∇·(C u)."""
    ...
    out_path = output_dir / "fig_036_036_coherence_divergence.png"
    ...
    ax.contour(C, R, div_Cu, levels=10, colors="black", alpha=0.3)
    ax.set_xlabel("C")
    ax.set_ylabel("R")
