...
Harmonic Resonating Dissonance \(D(t)\) acts as the **clock signal** of the Duality Kernel. Unlike classical clocks, HRD is:
...
\]  
where \(\alpha\) is the dissonance‑coupling coefficient.
