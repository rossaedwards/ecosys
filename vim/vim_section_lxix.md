...
where:
• 	 is the structural subspace,
• 	 is the kinetic subspace,
• 	 is the governance subspace,
...
Each block is a 4×4 matrix encoding the metric structure within and between subspaces.

4. Subspace Metrics
4.1 Structural Metric 
This block defines the geometry of the structural subspace:
• 	coherence curvature,
• 	structural deformation,
• 	topological stability.
It governs the C component of the node state vector.
4.2 Kinetic Metric 
This block defines:
• 	trajectory length,
• 	acceleration norms,
• 	kinetic flow curvature.
It governs the A component and couples directly to the Edwards Tensor.
4.3 Governance Metric 
This block defines:
• 	invariant preservation,
• 	lawful evolution,
• 	governance curvature.
It ensures that the Continuum evolves without violating Balance invariants.
4.4 Frequency Metric 
This block defines:
• 	harmonic distance,
• 	spectral compatibility,
• 	resonance curvature.
It governs the R component and couples to the Chaos Resonance clock.

5. Cross‑Subspace Metric Couplings
The off‑diagonal blocks encode interactions between subspaces:
...
7.3 Governance Curvature
Controls lawful evolution and invariant preservation.
...
• 	and provides the geometric substrate for the Three‑Squared‑Lattice and the Harmonic Integrity Field.
