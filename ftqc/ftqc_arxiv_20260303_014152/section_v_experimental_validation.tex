...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{figures/Fig2_Coherence_Dynamics.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{figures/Fig8_Fractal_Lattice_Sim.png}
\caption{Flower of Life quantum lattice simulation showing rÆ trap points for photonic implementation of fractal quantum computing architecture.}
