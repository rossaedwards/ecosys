% ============================================================================
% APS-FTQC-001 — publication manuscript (rigorous merge)
% Target: aurphyx.org / zenodo.org / desci.com
% Merged from: ftqc_zenodo_manuscript.tex (backbone, already the combined
%   public draft), ftqc_prx_manuscript.tex (PRX-condensed framing — checked,
%   nothing additive beyond what the zenodo backbone already carries more
%   carefully), ftqc_optica_manuscript.tex (photonic deep-dive — contributed
%   the photonic-platform comparison table and the itemized shop-cost
%   breakdown added below, both absent from the zenodo backbone).
% Loose section_ii-vii.tex / section_012_conclusion.md files in this folder
% are pre-existing draft decomposition, left untouched per Ross's call.
% ============================================================================
...
The source photonic manuscript itemizes its own standalone femtosecond-fabrication budget, reproduced here for reference. It totals \$104,800---close to, but not identical with, the \$48K (\$60K with contingency) Protocol~3 line in Table~\ref{tab:protocols}. The Protocol~3 line is scoped to the initial 6-month band-gap/flatband verification; the table below is the full 18-month fabrication-and-characterization program. Both figures are correct for what they scope; they have not been reconciled into one number.
...
The $1.6\times$ row is Ratio B (Sec.~\ref{subsec:gamma-split})---the 19-site cell's own coherence gain, not the fractal-embedded architecture's $16\times$ (Ratio A). This table isolates what the photonic lattice geometry alone contributes, distinct from the full FTQC architecture's fractal-embedding advantage.
