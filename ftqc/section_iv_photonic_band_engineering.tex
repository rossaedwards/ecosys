...
\begin{equation}
\xi \propto \left( \frac{E - E_c}{W} \right)^{- u}, \quad  u = \frac{1}{d_s - d_s^c},
\label{eq:loc_length}
\end{equation}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{Fig5_Band_Structure.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{Fig3_Anderson_Localization.png}
