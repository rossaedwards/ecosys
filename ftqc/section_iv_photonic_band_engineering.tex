...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{Fig5_Band_Structure.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{Fig3_Anderson_Localization.pdf}
\caption{Anderson localization on Sierpi\'{n}ski gasket demonstrating exponential decay $\exp(-x/\xi)$ with spectral dimension $d_s = 1.36 < 2$ for edge state confinement.}
