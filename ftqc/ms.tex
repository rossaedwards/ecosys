...
We analyze hexagonal photonic crystals with $C_{6v}$ point group symmetry. Plane-wave expansion of Maxwell's equations yields the band structure shown in Fig.~\ref{fig:Fig5_band_structure}. Key results:
\begin{itemize}
...
\begin{figure}[htbp]
    ...
    \caption{Photonic band structure of the $C_{6v}$ hexagonal lattice 
    computed via plane-wave expansion. Shaded region indicates the complete 
    TM band gap ($\Delta\omega/\omega_{\mathrm{mid}} = 21\%$).}
    \label{fig:Fig5_band_structure}
\end{figure}
