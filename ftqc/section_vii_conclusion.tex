...
The author thanks [collaborators] for valuable discussions on topological quantum field theory and photonic crystal design. This work was supported by [funding sources]. Numerical simulations were performed using [computational resources].
\end{acknowledgments}
