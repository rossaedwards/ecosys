# AINTS_REVIEW — `aurafs/src/resilience/`
...
- circuit_breaker, retry, recovery — overlaps `core/circuit_breaker.rs`.

**Wired:** **No.**  
**Era / voice:** Love + ENTERPRISE notes.

## Suggestions

- Pick one breaker. Do not grow a third in `mesh/swarm`.

## Clarifying questions needed

### Architectural
- Library helpers vs mesh swarm CB?

### Framework
- N/A.

### Vision
- Enterprise SLA language vs Aura personal OS?

### Intentions
- Wire into `lib.rs` only after compile graph.

### Design
- Keep unwired or fold into `core/`.

### Ideas
- Retry budgets from T₂, not magic numbers.
