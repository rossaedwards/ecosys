# AINTS_REVIEW — `aurafs/src/redteam/fuzzers/`
...
- `namespace_fuzzer.rs` — 368 LOC (implemented-looking)
- `shard_fuzzer.rs` — 346 LOC (implemented-looking)
- `soul_fuzzer.rs` — 295 LOC (implemented-looking)
