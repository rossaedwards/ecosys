...
- `init()` log only. Commented `pub mod metrics`.

**Wired:** **No.** ~10 LOC stub.  
**Era / voice:** Love-signed TODO.

## Suggestions

- Do not fill with invented daemons.
- k8s/helm/deploy live **outside** `src/`.

## Clarifying questions needed

### Architectural
- Will `ops/` ever exist, or is helm enough?

### Framework
- Not Audry events/tasks admin.

### Vision
- Operator plane for AuraFS cluster?

### Intentions
- Leave empty until compile-graph PR is done.

### Design
- Stay out of `lib.rs`.

### Ideas
- If added: wrap `monitoring/` only.
