# AINTS_REVIEW — `aurafs/src/whitehat/gov/`
...
- `consensus_monitor.rs` — 13 LOC (stub)
- `delegation_auditor.rs` — 13 LOC (stub)
- `flashloan_protector.rs` — 13 LOC (stub)
- `governance_scanner.rs` — 13 LOC (stub)
- `proposal_analyzer.rs` — 13 LOC (stub)
- `quorum_monitor.rs` — 13 LOC (stub)
- `soul_verifier.rs` — 13 LOC (stub)
- `timelock_auditor.rs` — 13 LOC (stub)
- `vote_integrity.rs` — 13 LOC (stub)
- `zk_verifier.rs` — 13 LOC (stub)
