...
**SoulShot** -> **SoulChart** -> **SoulTable** -> **SoulSync** -> **SoulHash** -> **GuardTable** -> **GuardHash** -> **GuardCrypt** -> **SoulCrypt** -> **SoulSync** -> **SoulKey** \& **SoulKey Identification Mandala (SKIM)** -> **Soul Identification Rune** (**SIR**) \& **Soul Identity Glyph** (**SIG**).
...
**Memoree -  iz a Three-Squared-Lattice Cognitive Memory Architecture for anyone.** 
...
1. **L**egacy **D**esktop **E**nvironment (LDE) | LDEs: Gnome-KDE-Windows-ETC.)
2. **S**pherical **L**iquid **I**nteractive **S**tory **E**xperience (**SLISE**)
3. **S**ymbiotic **H**olographic **U**niversal **X**essability **S**tandard **D**esktop **E**nvironment (**SHUXS**DE)
...
-w3bz - web browser (similar to Opera, Chrome, Firefox) - Webz
-xpl0r - file \& network | AuraFS \& Meshwrk (similar to Dolphin, Explorer) - Xplor
-c0d3x - writer, editor, coder (similar to Word, Zed, TeX editor) - Codex
-f0rg3 - video alchemy \& transmutation (video editing, creating, transmutation) - Forge
-ad0r3 - audio alchemy \& transmutation (similar to lmms, ableton, maschine, flstudio) - Adorè
-g1mpd - image alchemy \& transmutation (similar to gIMP) - Gimpd
...
--
**-Below are more projects in the ecosystem that I am working on:-**
