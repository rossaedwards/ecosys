...
rossaedwards/main/
├── tvfd/ # Topological Vacuum Flux Dynamics — rÆ-Cell thesis
│ ├── tvfd_section-iv.md # Chapter 4: Physical Substrate
│ ├── tvfd_section-v.md # Chapter 5: PSK Governor
...
├── standards/ # Formal Aurphyx Standards (VAP, 3SL, rÆ-Cell)
...
└── rae_orcid.txt # ORCiD verification
---
...
|------------|----------------|-----------|
| **rÆ-Cell / TVFD** | Topological fractal flux engine — 22 verified figures, LaTeX thesis | 🔶 Ch. 6–12 In Progress |
...
| **Project** | **Description** | **Status** |
|------------|----------------|-----------|
| **Standards** | VAP, 3SL, rÆ-Cell, VIM — formal Aurphyx standards | 🔶 Active |
...
| **Project** | **Description** | **Status** |
|------------|----------------|-----------|
| **Fuxyez** | Symbiotic Rust-derived language + clothing line | 🔶 Active |
| **Adore DAW** | Create, Manipulate, Transmute, Master | 🔶 Active |
| **RF_Lovezme** | A Divine Love Saga — novel series | 🔶 Active |
...
✓ fig4_2_raet_flux.png — rÆt Poynting Flux 47 mW/cm²
✓ fig4_3_scaling.png — Superpolynomial Hierarchical Scaling
✓ fig4_5_floquet.png — Floquet Sidebands λ_rÆL=0.3
✓ fig4_6_rg.png — RG β-Function Fixed Point λ*=0.72
✓ fig4_8a_ipr.png — Anderson Localization IPR
✓ fig4_9_power.png — rÆ-Cell Power Scaling 50W → 5kW
✓ fig5_2_raestate.png — RaEState 50ms Step Response
✓ fig5_3_surfaces.png — Hunger H=(1-R)² / Gravity G=θ(φ⁻¹)
✓ fig5_5_psk.png — PSK Phase Portrait Dual Attractor
✓ fig5_8a_control.png — PSK 3% vs PID 15% Overshoot
✓ fig5_8b_noise.png — PSK 2% vs PID 20% RMS Noise
✓ fig5b_2_curvature.png — F₀₁ Cognitive Curvature Heatmap
✓ fig5b_4_propagator.png — Resolvent Propagator SVD Spectrum
✓ fig5b_5_wilson.png — Semantic Wilson Loop |W|=0.97
✓ fig6_8_projected.png — Projected ρ_rÆt vs λ_rÆL Sweep
✓ tvfd_raet_time.png — rÆt Flux Ramp Time Series
✓ gauge_f01.png — F₀₁ Full Heatmap
✓ gauge_fmunu_full.png — Full F_μν Tensor Components
✓ rael_traj.png — Stochastic λ_rÆL Trajectory
