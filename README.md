...
rossaedwards/main/
├── tvfd/ # Topological Vacuum Flux Dynamics — Balance State Vector-Cell thesis
...
✓ fig4_5_floquet.png — Floquet Sidebands λ_x_L=0.3
✓ fig4_6_rg.png — RG β-Function Fixed Point λ*=0.72
✓ fig4_8a_ipr.png — Anderson Localization IPR
✓ fig4_9_power.png — Balance State Vector-Cell Power Scaling 50W → 5kW
...
✓ fig6_8_projected.png — Projected ρ_x_t vs λ_x_L Sweep
✓ tvfd_raet_time.png — x_t Flux Ramp Time Series
