...
**Task ref:** n/a
**Files touched:**
- `INVARIANTS.md`, `.cursorrules`, `CLAUDE.md` — SIX/ICX/SUXS-IFO naming lock corrected (SIX = Somatic Coherence aXis, ICX = Identity Coherence aXis, SUXS-IFO = Symbiotic Universal Xessability Standards Intelligence Fusion Operator)
...
**Decisions made:**
- SIX = Somatic Coherence aXis (not "Symbiotic", "Sensorimotor", or "Intelligence") — locked 2026-08-25 under the uniform Coherence triad (Somatic / Systemic / Identity). "Intelligence" belongs to the fusion operator (SUXS-IFO / Audry).
