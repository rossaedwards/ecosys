...
\subsubsection{3.1 Sensorimotor Integration aXis (SIX)}\label{sensorimotor-integration-axis-six}
...
\subsubsection{3.3 Soul Identity aXis (ICX)}\label{soul-identity-axis-icx}
