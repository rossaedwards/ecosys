...
title: APS‑TSLCA-SECTION-003
description: The Three-Squared-Lattice Cognitive Architecture is built on three orthonormal cognitive aXes.
...
### 3.2 Systemic Coherence aXis (SCX)

SCX governs semantics, reasoning, invariants, and system‑level coherence. It defines the **semantic axis** of the lattice, providing the structures that allow information to be interpreted, transformed, and maintained consistently across time.
...
Although orthogonal, the aXiss are interdependent. Cognition emerges from their interactions:
- SIX grounds SCX in reality.  
...
### 3.7 aXes as Basis Vectors of the Lattice
...
### 3.8 aXes as Interfaces

Each aXis also functions as an interface layer:
- SIX interfaces with sensors, actuators, and accessibility systems.  
